...
export const Route = createFileRoute("/call-confirmation")({
  head: () => ({
    meta: [
      { title: "Congrats! Your Call Is Booked! · Vacarya" },
      {
        name: "description",
        content:
          "Your call is booked. Watch the video, accept the calendar invite, and get your questions answered before we speak.",
      },
      { name: "robots", content: "noindex" },
    ],
  }),
  component: CallConfirmationPage,
});
